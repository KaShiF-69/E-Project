...
<head>
    ...
    <title>Book Orders | Admin Dashboard</title>
                    ...
                    <ul>
                        ...
                        <li class="has-sub-menu"><a href="#"><i class="ti-shopping-cart"></i>
                            ...
                            <ul class="side-header-sub-menu">
                                ...
                                <li><a href="order-list.html"><span>Orders</span></a></li>
                                <li><a href="Book_order.html"><span>Book Orders</span></a></li>
                            </ul>
                        </li>
                        <li><a href="users.html"><i class="zmdi zmdi-account"></i> <span>Users</span></a></li>
                    </ul>
                </nav>
            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>eCommerce <span>/ Book Order</span></h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="action h4">
                                        <div class="table-action-buttons">
                                            ...
                                            <a class="edit button button-box button-xs button-info" href="#"><i
        ...
        <div class="footer-section">
            <div class="container-fluid">
                ...
                <div class="footer-copyright text-center">
                    <p class="text-body-light">2023 &copy; <a
                            href="#">Ice Cream</a></p>
                </div>
